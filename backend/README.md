...
## Project Structure
    ...
    ├── datingappstudio_dev_27272  # Django project configurations
...
1. Clone this repo and `cd datingappstudio_dev_27272`
...
2. Clone this repo and `cd datingappstudio_dev_27272`
